...
Plugin.prototype.collectionReplace = async function(name: string, scope: unknown, entries?: CollectionPutEntry[], label?: string, roles?: unknown) {
  const result = await this.call(
    MethodCollectionReplace,
    {
      name,
