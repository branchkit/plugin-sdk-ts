...
declare module "./plugin.js" {
  interface Plugin {
    ...
    collectionReplace(name: string, scope: unknown, entries?: CollectionPutEntry[], label?: string, roles?: Record<string, FieldDisplay>): Promise<CollectionReplaceResponse>;
...
Plugin.prototype.collectionReplace = async function(name: string, scope: unknown, entries?: CollectionPutEntry[], label?: string, roles?: Record<string, FieldDisplay>) {
  const result = await this.call(
    MethodCollectionReplace,
    {
      name,
