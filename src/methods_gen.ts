...
declare module "./plugin.js" {
  interface Plugin {
    ...
    calibrationCaptureProbe(items: ProbeItem[], model: string, stage: string, maxActive?: number): Promise<ProbeLine[]>;
