...
import {
  ...
  MethodPipelinesIngestTranscript,
...
declare module "./plugin.js" {
  interface Plugin {
    ...
    pipelinesIngestTranscript(name: string, text: string, confidence?: number, isFinal?: boolean): Promise<PipelinesIngestTranscriptResponse>;
...
Plugin.prototype.eventsQuery = async function(correlationId?: string, limit?: number) {
  const result = await this.call(
    MethodEventsQuery,
    {
      correlation_id: correlationId,
...
Plugin.prototype.pipelinesIngestTranscript = async function(name: string, text: string, confidence?: number, isFinal?: boolean) {
  const result = await this.call(
    MethodPipelinesIngestTranscript,
    {
      name,
  ...
  return result as PipelinesIngestTranscriptResponse;
};
