...
declare module "./plugin.js" {
  interface Plugin {
    ...
    overridesControl(collection?: string): Promise<ControlRow[]>;
...
Plugin.prototype.overridesControl = async function(collection?: string) {
  const result = await this.call(
    MethodOverridesControl,
    {
      collection,
